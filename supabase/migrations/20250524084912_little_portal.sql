/*
  ...
  1. New Tables
    - `shopify_stores`
      - Store connection details including domain and access token
      - Links to main stores table
    - `shopify_customers`
      - Customer data synced from Shopify
      - Includes order counts and total spent
    - `shopify_orders`
...
-- Add updated_at trigger for shopify_customers
