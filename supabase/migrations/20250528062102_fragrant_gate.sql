/*
  # Fix graph subscriptions table and policies

  1. Changes
    - Safely create graph_subscriptions table if it doesn't exist
    - Drop and recreate policies and triggers to avoid conflicts
